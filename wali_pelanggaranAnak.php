          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url('Wali/pelanggaranAnak')?>"><small><?= $page ;?></small></a></li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
            ...
            <table id="b" class="table table-bordered table-striped display nowrap" style="width:100%">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?= $pel->point ;?></td>
                  <td>
                    <a class="btn btn-sm btn-primary" style="margin-right:10px; width: 32px; height: 32px;" href="<?= base_url('Wali/pelanggaranAnakOnePrint') ?>" target="blank" title="Print"><i class="fas fa-print"></i></a>
                    <a class="btn btn-sm btn-info" style="margin-right:10px; height: 30px; width: 30px;" href="<?= base_url('Wali/pelanggaranAnakDetail') ?>" title="Detail"><i class="fas fa-info"></i></a>
                  </td>
                </tr>
              <?php endforeach; ?>
              <tr>
